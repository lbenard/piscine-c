...
/*   Updated: 2018/07/13 15:23:13 by lbenard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_convert_base(char *nbr, char *base_from, char *base_to)
{
	int		base_to_decimal;
	char	*zero;
	char*	decimal_to_base;

	base_to_decimal = ft_base_to_decimal(nbr, base_from);
	if (base_to_decimal == 0)
	{
		zero = malloc(sizeof(char) * 2);
		zero = "0\0";
		return (zero);
	}
	decimal_to_base = ft_decimal_to_base(base_to_decimal, base_to);
